...
# --- LOAD ASSETS---
lottie_grocery = load_lottieurl("https://lottie.host/838f641e-b2c4-4962-bfc2-1f8062c10d86/08Bgbj42XC.json")
...
with right_column:
    st_lottie(lottie_grocery, height=400, width=500, key="food options")
